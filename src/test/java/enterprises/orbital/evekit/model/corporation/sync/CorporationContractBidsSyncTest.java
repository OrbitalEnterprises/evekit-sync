...
public class CorporationContractBidsSyncTest extends SyncTestBase {
  ...
  public void testContractBidSyncUpdate() throws Exception {
    ...
    Assert.assertEquals(testDate, Corporation.getCorporation(syncAccount).getContractBidsExpiry());
    Assert.assertEquals(SyncState.UPDATED, CorporationSyncTracker.getUnfinishedTracker(syncAccount).getContractBidsStatus());
    Assert.assertNull(CorporationSyncTracker.getUnfinishedTracker(syncAccount).getContractBidsDetail());
  }
  ...
  public void testContractBidSyncUpdateSkip() throws Exception {
    ...
    Assert.assertEquals(prevDate, Corporation.getCorporation(syncAccount).getContractBidsExpiry());
    Assert.assertEquals(SyncState.UPDATED, CorporationSyncTracker.getUnfinishedTracker(syncAccount).getContractBidsStatus());
    Assert.assertNull(CorporationSyncTracker.getUnfinishedTracker(syncAccount).getContractBidsDetail());
  }
