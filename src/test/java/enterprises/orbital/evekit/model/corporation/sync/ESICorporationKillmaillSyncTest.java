...
public class ESICorporationKillmaillSyncTest extends SyncTestBase {
  ...
  public void setup() throws Exception {
    ...
    ESIEndpointSyncTracker.getOrCreateUnfinishedTracker(corpSyncAccount, ESISyncEndpoint.CORP_KILL_MAIL, 1234L);
  ...
  private void setupOkMock() throws Exception {
    ...
    List<GetCorporationsCorporationIdKillmailsRecent200Ok>[] pages = new List[killmailPages.length];
