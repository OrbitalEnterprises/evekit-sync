...
public class CharacterSheetSyncTest extends SyncTestBase {
  ...
  public void compareCharacterSheetBalanceWithTestData(CharacterSheetBalance sheet) {
    Assert.assertEquals(sheet.getBalance().doubleValue(), ((Double) testData[0][22]), 0.1);
  }

  public void compareCharacterSheetJumpWithTestData(CharacterSheetJump sheet) {
  ...
  public void compareCharacterSheetCloneWithTestData(CharacterSheetClone sheet) {
    Assert.assertEquals(sheet.getCloneJumpDate(), (long) ((Long) testData[0][26]));
  }

  public void compareCharacterSheetWithTestData(CharacterSheet sheet) {
  ...
  public CharacterSheetBalance makeCharacterSheetBalanceObject(long time, Object[] instanceData) throws Exception {
  ...
  public CharacterSheetJump makeCharacterSheetJumpObject(long time, Object[] instanceData) throws Exception {
    CharacterSheetJump sheet = new CharacterSheetJump((Long) testData[0][33], (Long) testData[0][34], (Long) testData[0][35]);
    sheet.setup(syncAccount, time);
    return sheet;
  }

  public CharacterSheetClone makeCharacterSheetCloneObject(long time, Object[] instanceData) throws Exception {
    CharacterSheetClone sheet = new CharacterSheetClone((Long) testData[0][26]);
    sheet.setup(syncAccount, time);
    return sheet;
  }

  public CharacterSheet makeCharacterSheetObject(long time, Object[] instanceData) throws Exception {
    CharacterSheet sheet = new CharacterSheet(
        ...
        (String) instanceData[4], (String) instanceData[5], (String) instanceData[6], (String) instanceData[7], (Long) instanceData[8],
        (String) testData[0][23], (Long) testData[0][24], (Integer) instanceData[11], (Integer) instanceData[12], (Integer) instanceData[13],
        (Integer) instanceData[14], (Integer) instanceData[15], (Long) testData[0][25], (Long) testData[0][27], (Long) testData[0][28],
        (Integer) testData[0][29], (Integer) testData[0][30], (Long) testData[0][32]);
    sheet.setup(syncAccount, time);
    return sheet;
  }

  public void compareSkillWithTestData(Collection<CharacterSkill> skills) {
  ...
  public CharacterSkill makeSkillObject(long time, Object[] instanceData) throws Exception {
  ...
  public void compareImplantWithTestData(List<Implant> implants) {
  ...
  public Implant makeImplantObject(long time, Object[] instanceData) throws Exception {
    Implant implant = new Implant((Integer) instanceData[0], (String) instanceData[1]);
    implant.setup(syncAccount, time);
    return implant;
  }

  public void compareJumpCloneWithTestData(List<JumpClone> clones) {
  ...
  public JumpClone makeJumpCloneObject(long time, Object[] instanceData) throws Exception {
  ...
  public void compareJumpCloneImplantWithTestData(List<JumpCloneImplant> cloneImplants) {
  ...
  public JumpCloneImplant makeJumpCloneImplantObject(long time, Object[] instanceData) throws Exception {
